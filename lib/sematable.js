    ...
    _createClass(DataTable, [{
      ...
      value: function render() {
        ...
        var _configs$showPageSize = configs.showPageSize,
            ...
            _configs$tableContain = configs.tableContainerClassName,
            tableContainerClassName = _configs$tableContain === undefined ? 'col-md-12' : _configs$tableContain,
        ...
        var columnHeaders = _lodash2.default.mapValues(columnMap, function (value, key) {
          return {
            ...
            title: value.title,
            handleClick: !!value.handleClick ? value.handleClick : function (k) {
