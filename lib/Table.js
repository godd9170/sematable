  ...
  _createClass(Table, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          _props$sortAscIconCla = _props.sortAscIconClass,
          sortAscIconClass = _props$sortAscIconCla === undefined ? 'fa fa-long-arrow-up' : _props$sortAscIconCla,
          _props$sortDescIconCl = _props.sortDescIconClass,
          sortDescIconClass = _props$sortDescIconCl === undefined ? 'fa fa-long-arrow-down' : _props$sortDescIconCl,
          _props$sortIconClass = _props.sortIconClass,
          sortIconClass = _props$sortIconClass === undefined ? 'fa fa-arrows-v' : _props$sortIconClass;
